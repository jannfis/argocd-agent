...
func (c *eventStreamClient) Subscribe(ctx context.Context, opts ...grpc.CallOption) (EventStream_SubscribeClient, error) {
	stream, err := c.cc.NewStream(ctx, &EventStream_ServiceDesc.Streams[0], "/appstreamapi.EventStream/Subscribe", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *eventStreamClient) Push(ctx context.Context, opts ...grpc.CallOption) (EventStream_PushClient, error) {
	stream, err := c.cc.NewStream(ctx, &EventStream_ServiceDesc.Streams[1], "/appstreamapi.EventStream/Push", opts...)
	if err != nil {
		return nil, err
	}
...
var EventStream_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "appstreamapi.EventStream",
